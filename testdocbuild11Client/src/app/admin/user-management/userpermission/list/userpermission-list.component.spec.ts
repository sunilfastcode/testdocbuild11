  ...
  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [UserpermissionListComponent, ListComponent],
        imports: [TestingModule],
        providers: [UserpermissionService, ChangeDetectorRef],
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(
        `/userpermission/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`
      );
    });
