...
import { IUserrole, UserroleService, UserroleDetailsComponent, UserroleListComponent, UserroleNewComponent } from '../';
  ...
  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [UserroleListComponent, ListComponent],
        imports: [TestingModule],
        providers: [UserroleService, ChangeDetectorRef],
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(
        `/userrole/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`
      );
    });
