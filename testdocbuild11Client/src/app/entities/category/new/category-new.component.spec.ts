  ...
  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [CategoryNewComponent, NewComponent, FieldsComp],
        imports: [TestingModule],
        providers: [CategoryService, { provide: MAT_DIALOG_DATA, useValue: {} }],
  ...
  describe('Integration tests', () => {
    ...
    describe('', () => {
      it('should set the passed data to form', async () => {
        TestBed.configureTestingModule({
          declarations: [CategoryNewComponent, NewComponent, FieldsComp].concat(EntryComponents),
          imports: [TestingModule],
          providers: [CategoryService, { provide: MAT_DIALOG_DATA, useValue: relationData }],
        });
