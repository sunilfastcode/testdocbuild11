...
import { ILanguage, LanguageService, LanguageDetailsComponent, LanguageListComponent, LanguageNewComponent } from '../';

describe('LanguageListComponent', () => {
  let fixture: ComponentFixture<LanguageListComponent>;
  let component: LanguageListComponent;
  let el: HTMLElement;
  let constData: ILanguage[] = [
    {
      languageId: 1,
      lastUpdate: new Date(),
      name: 'name1',
  ...
  let data: ILanguage[] = [...constData];

  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [LanguageListComponent, ListComponent],
        imports: [TestingModule],
        providers: [LanguageService, ChangeDetectorRef],
  ...
  describe('Integration tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            ...
            { path: 'language/:id', component: LanguageDetailsComponent },
          ]),
        ],
        providers: [LanguageService, ChangeDetectorRef],
      }).compileComponents();
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(
        `/language/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`
      );
    });
